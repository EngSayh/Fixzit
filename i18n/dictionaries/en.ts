const en = {
  ...
  finance: {
    ...
    journal: {
      ...
      descriptionPlaceholder: 'Brief description of the journal entry',
      sourceReference: 'Source Reference Number',
      journalLines: 'Journal Lines',
      quickBalance: 'Quick Balance',
      clearAmounts: 'Clear Amounts',
      addLine: 'Add Line',
      searchAccount: 'Search account by code or name',
      searchAccountLabel: 'Search account',
      ...
      debitsExceed: 'Debits exceed credits by',
      creditsExceed: 'Credits exceed debits by',
