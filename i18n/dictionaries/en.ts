...
const en: TranslationDictionary = {
  ...
  notifications: {
    ...
    toast: {
      noOrgId: 'No organization ID found',
      markReadFailed: 'Failed to mark notification as read',
      markingCount: 'Marking {{count}} notifications as read...',
      markedCount: 'Marked {{count}} notifications as read',
      archived: 'Archived {{count}} notifications',
      deleted: 'Deleted {{count}} notifications',
      markedImportant: 'Marked {{count}} notifications as important',
      mutedCategory: 'Muted notifications for category: {{category}}',
      muteSelectCategory: 'Please select a specific category first to mute it',
      clearedAll: 'All notifications cleared',
    },
    report: {
      filenamePrefix: 'notification-report-',
    },
    accessibility: {
    ...
    messages: {
      ...
      selectCategoryToMute: 'Please select a category before muting',
    },
    notificationTypes: {
      workOrder: 'Work Order',
      payment: 'Payment',
