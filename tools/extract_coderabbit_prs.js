...
arr.forEach(pr => {
  ...
  const hasCodeRabbit = user.includes('coderabbit') || 
...
fs.writeFileSync(outPath, JSON.stringify({ generated_at: new Date().toISOString(), total_prs: arr.length, hits: hits }, null, 2));
