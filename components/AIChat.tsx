        ...
        <div className="p-6 border-t border-gray-200">
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-4 py-3 bg-[var(--fixzit-primary)] text-white rounded-lg hover:bg-[var(--fixzit-primary-dark)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
