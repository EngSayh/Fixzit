  ...
  return (
    ...
    >
      <div className={`${screenInfo.isMobile ? 'p-3' : 'p-4'}`}>
        ...
        {/* Role & Plan */}
        {role !== 'guest' && (
          <section aria-label={t('sidebar.accountInfo', 'Account info')} className="mb-4 p-3 bg-[#0061A8] rounded-lg">
                  ...
                  return (
                    <li key={m.id}>
                      ...
                      >
                        ...
                        {isActive && (
                          <span
                            className={`${translationIsRTL ? 'mr-auto' : 'ml-auto'} inline-block w-2 h-2 bg-white rounded-full`}
                            aria-hidden
                          />
                        )}
                      </Link>
              ...
              return (
                <li key={link.id}>
                  ...
                  >
                    ...
                    {isActive && (
                      <span className={`${translationIsRTL ? 'mr-auto' : 'ml-auto'} inline-block w-2 h-2 bg-white rounded-full`} aria-hidden />
                    )}
                  </Link>
                </li>
              );
        ...
        {isAuthenticated && (
          <div className="border-t border-white/20 pt-4 mt-4">
            ...
            <Link
              href="/help"
              className={`w-full flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-200 text-gray-100 hover:bg-white/10 hover:text-white hover:translate-x-1 ${translationIsRTL ? 'flex-row-reverse text-right' : 'text-left'}`}
