  ...
  const companyInfoSchema = useMemo(
    () =>
      z.object({
        ...
        businessNameAr: z
          .string()
          .min(2, auto('Arabic business name required', 'validation.businessNameAr')),
        crNumber: z
          .string()
          .regex(/^\d{10}$/, auto('CR number must be 10 digits', 'validation.crNumber')),
        vatNumber: z.string().optional(),
        businessType: z.enum(['individual', 'llc', 'corporation']),
        addressLine1: z.string().min(5, auto('Address required', 'validation.addressLine1')),
        addressLine2: z.string().optional(),
        city: z.string().min(2, auto('City required', 'validation.city')),
        province: z.string().min(2, auto('Province required', 'validation.province')),
        postalCode: z.string().min(5, auto('Postal code required', 'validation.postalCode')),
        country: z.string().default('SA'),
        contactPhone: z.string().min(10, auto('Phone number required', 'validation.phone')),
        contactEmail: z.string().email(auto('Valid email required', 'validation.email')),
      }),
    [auto]
  );
    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input 
            ...
            placeholder={auto('ABC Trading Company', 'fields.businessNameEn.placeholder')}
          />
        ...
        <div>
          ...
          <Input 
            ...
            placeholder={auto('شركة ABC التجارية', 'fields.businessNameAr.placeholder')}
            dir="rtl"
          />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label htmlFor="crNumber">
            {auto('Commercial Registration (CR) Number *', 'fields.crNumber.label')}
          </Label>
          <Input 
            id="crNumber"
            {...register('crNumber')}
        ...
        <div>
          ...
          <Input 
            id="vatNumber"
            {...register('vatNumber')}
            placeholder={auto('300000000000003', 'fields.vatNumber.placeholder')}
          />
          {errors.vatNumber && (
      ...
      <div>
        ...
        >
          <option value="individual">
            {auto('Individual/Sole Proprietor', 'fields.businessType.individual')}
          </option>
          <option value="llc">
      ...
      <div>
        ...
        <Input 
          ...
          placeholder={auto('123 Main Street', 'fields.addressLine1.placeholder')}
        />
        {errors.addressLine1 && (
      ...
      <div>
        ...
        <Input 
          ...
          placeholder={auto('Building 5, Unit 201', 'fields.addressLine2.placeholder')}
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input 
            ...
            placeholder={auto('+966 50 123 4567', 'fields.contactPhone.placeholder')}
          />
          {errors.contactPhone && (
        ...
        <div>
          ...
          <Input 
            ...
            placeholder={auto('contact@example.com', 'fields.contactEmail.placeholder')}
          />
          {errors.contactEmail && (
