...
export function JobApplicationForm({ jobId }: JobApplicationFormProps) {
  ...
  return (
    ...
    >
      ...
      {/* General error */}
      {errors.general && (
        <div className="mt-4 p-3 bg-destructive/10 border border-destructive/20 rounded text-destructive text-sm" role="alert" aria-live="assertive" data-testid="general-error">
          {errors.general}
        </div>
      )}
