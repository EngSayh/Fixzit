...
export const CATEGORY_CONFIG: Record<WorkOrderCategory, { label: string; icon: string; color: string; description: string }> = {
  general: {
    label: 'General',
    icon: '🛠️',
...
export const PRIORITY_CONFIG: Record<WorkOrderPriority, { label: string; icon: string; color: string; bgColor: string; description: string }> = {
  low: {
    label: 'Low',
    icon: '🟢',
...
export const STATUS_CONFIG: Record<WorkOrderStatus, { label: string; icon: string; color: string; bgColor: string; description: string }> = {
  draft: {
    label: 'Draft',
    icon: '📝',
    color: 'text-gray-700',
