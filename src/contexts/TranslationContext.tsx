...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    // Footer
  'footer.brand': 'فيكزيت',
  'footer.description': 'إدارة المنشآت + الأسواق في منصة واحدة. تبسيط العمليات وتحسين التكاليف وتعزيز الإنتاجية بحلولنا الشاملة للمؤسسات.',
  ...
  'footer.newsletter.description': 'احصل على آخر التحديثات والنصائح والبصائر الصناعية مباشرة في بريدك الإلكتروني.',
  ...
  fr: {
    ...
    // Footer
    'footer.brand': 'Fixzit',
    'footer.description': 'Gestion des installations + marchés en une plateforme. Rationalisez les opérations, optimisez les coûts et améliorez la productivité avec notre solution d\'entreprise complète.',
    ...
    'footer.solutions': 'Solutions',
    'footer.fm': 'Gestion des Installations',
    'footer.souq': 'Marché des Matériaux',
    'footer.aqar': 'Immobilier',
    ...
    'footer.contact.phone': '+966 50 123 4567',
    'footer.contact.email': 'info@fixzit.com',
    'footer.contact.address': 'Riyad, Arabie Saoudite',
    'footer.newsletter.title': 'Restez Informé',
    'footer.newsletter.description': 'Recevez les dernières mises à jour, conseils et informations sur l\'industrie directement dans votre boîte mail.',
  ...
  pt: {
    ...
    // Footer
    'footer.brand': 'Fixzit',
    'footer.description': 'Gestão de instalações + mercados em uma plataforma. Otimize operações, custos e produtividade com nossa solução empresarial abrangente.',
    ...
    'footer.fm': 'Gestão de Instalações',
    'footer.souq': 'Mercado de Materiais',
    'footer.aqar': 'Imobiliário',
    'footer.integrations': 'Integrações',
    'footer.api': 'Acesso API',
    ...
    'footer.contact.phone': '+966 50 123 4567',
    'footer.contact.email': 'info@fixzit.com',
    'footer.contact.address': 'Riade, Arábia Saudita',
    'footer.newsletter.title': 'Mantenha-se Atualizado',
    'footer.newsletter.description': 'Receba as últimas atualizações, dicas e insights do setor diretamente na sua caixa de entrada.',
  ...
  ru: {
    ...
    // Footer
    'footer.brand': 'Fixzit',
    'footer.description': 'Управление объектами + рынки в одной платформе. Оптимизируйте операции, затраты и производительность с помощью нашего комплексного корпоративного решения.',
    ...
    'footer.fm': 'Управление Объектами',
    'footer.souq': 'Рынок Материалов',
    'footer.aqar': 'Недвижимость',
    'footer.integrations': 'Интеграции',
    'footer.api': 'Доступ API',
    ...
    'footer.contact.phone': '+966 50 123 4567',
    'footer.contact.email': 'info@fixzit.com',
    'footer.contact.address': 'Эр-Рияд, Саудовская Аравия',
    'footer.newsletter.title': 'Будьте в курсе',
    'footer.newsletter.description': 'Получайте последние обновления, советы и аналитику отрасли прямо в ваш почтовый ящик.',
  ...
  es: {
    ...
    // Footer
    'footer.brand': 'Fixzit',
    'footer.description': 'Gestión de instalaciones + mercados en una plataforma. Optimice operaciones, costos y productividad con nuestra solución empresarial integral.',
    'footer.company': 'Empresa',
    ...
    'footer.fm': 'Gestión de Instalaciones',
    'footer.souq': 'Mercado de Materiales',
    'footer.aqar': 'Bienes Raíces',
    'footer.integrations': 'Integraciones',
    'footer.api': 'Acceso API',
    ...
    'footer.contact.phone': '+966 50 123 4567',
    'footer.contact.email': 'info@fixzit.com',
    'footer.contact.address': 'Riad, Arabia Saudita',
    'footer.newsletter.title': 'Manténgase Actualizado',
    'footer.newsletter.description': 'Reciba las últimas actualizaciones, consejos y conocimientos de la industria directamente en su bandeja de entrada.',
    'footer.newsletter.placeholder': 'Ingrese su correo electrónico',
  ...
  ur: {
    ...
    // Footer
    'footer.brand': 'فکزٹ',
    'footer.description': 'سہولت مینجمنٹ + مارکیٹ پلیس ایک پلیٹ فارم میں۔ ہمارے جامع انٹرپرائز حل کے ساتھ کارروائیاں، اخراجات اور پیداواری صلاحیت کو بہتر بنائیں۔',
    'footer.company': 'کمپنی',
    'footer.about': 'ہمارے بارے میں',
    'footer.careers': 'کیریئرز',
    'footer.contact': 'رابطہ',
    'footer.partners': 'شراکت دار',
    'footer.investors': 'سرمایہ کار',
    'footer.solutions': 'حلول',
    'footer.fm': 'سہولت مینجمنٹ',
    'footer.souq': 'مٹیریل مارکیٹ پلیس',
    'footer.aqar': 'ریئل اسٹیٹ',
    'footer.integrations': 'انٹیگریشنز',
    'footer.api': 'API رسائی',
    'footer.docs': 'دستاویزات',
    'footer.community': 'کمیونٹی',
    'footer.status': 'سسٹم کی حیثیت',
    'footer.legal': 'قانونی',
    'footer.privacy': 'پرائیویسی',
    'footer.terms': 'شرائط',
    'footer.cookies': 'کوکیز',
    'footer.accessibility': 'رسائی',
    'footer.sitemap': 'سائٹ کا نقشہ',
    ...
    'footer.contact.phone': '+966 50 123 4567',
    'footer.contact.email': 'info@fixzit.com',
    'footer.contact.address': 'ریاض، سعودی عرب',
    'footer.newsletter.title': 'اپ ڈیٹ رہیں',
    'footer.newsletter.description': 'صنعت کے تازہ ترین اپ ڈیٹس، ٹپس اور بصیرت براہ راست آپ کے ان باکس میں حاصل کریں۔',
    'footer.newsletter.placeholder': 'اپنا ای میل درج کریں',
    'footer.newsletter.subscribe': 'سبسکرائب کریں',
    'footer.newsletter.success': 'سبسکرائب کرنے کا شکریہ!',
  ...
  hi: {
    ...
    'footer.description': 'सुविधा प्रबंधन + बाजार एक मंच में। हमारे व्यापक उद्यम समाधान के साथ संचालन, लागत और उत्पादकता को अनुकूलित करें।',
    ...
    'footer.fm': 'सुविधा प्रबंधन',
    'footer.souq': 'सामग्री बाजार',
    'footer.aqar': 'रियल एस्टेट',
    'footer.integrations': 'एकीकरण',
    'footer.api': 'API एक्सेस',
    'footer.docs': 'दस्तावेजीकरण',
    'footer.community': 'समुदाय',
    'footer.status': 'सिस्टम स्थिति',
    'footer.legal': 'कानूनी',
    'footer.privacy': 'गोपनीयता',
    'footer.terms': 'शर्तें',
    'footer.cookies': 'कुकीज',
    ...
    'footer.contact.phone': '+966 50 123 4567',
    'footer.contact.email': 'info@fixzit.com',
    'footer.contact.address': 'रियाद, सऊदी अरब',
    'footer.newsletter.title': 'अपडेट रहें',
    'footer.newsletter.description': 'उद्योग की नवीनतम अपडेट, टिप्स और अंतर्दृष्टि सीधे आपके इनबॉक्स में प्राप्त करें।',
    'footer.newsletter.placeholder': 'अपना ईमेल दर्ज करें',
    'footer.newsletter.subscribe': 'सब्स्क्राइब करें',
    'footer.newsletter.success': 'सब्स्क्राइब करने के लिए धन्यवाद!',
  ...
  zh: {
    ...
    // Footer
    'footer.brand': 'Fixzit',
    'footer.description': '设施管理 + 市场在一个平台中。使用我们的综合企业解决方案优化运营、成本和生产力。',
    'footer.company': '公司',
    'footer.about': '关于我们',
    'footer.careers': '职业',
    'footer.contact': '联系',
    ...
    'footer.contact.phone': '+966 50 123 4567',
    'footer.contact.email': 'info@fixzit.com',
    'footer.contact.address': '利雅得，沙特阿拉伯',
    'footer.newsletter.title': '保持更新',
    'footer.newsletter.description': '获取最新的更新、提示和行业洞察，直接发送到您的收件箱。',
