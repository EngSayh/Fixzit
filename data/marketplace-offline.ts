...
const categories: OfflineCategory[] = [
  ...
  { id: 'cat-electrical', slug: 'electrical', name: { en: 'Electrical Systems' } },
  { id: 'cat-finishes', slug: 'finishes', name: { en: 'Finishes & Interiors' } },
...
const carousels = [
  ...
  { category: categories[2], items: baseProducts.slice(4, 5).concat(baseProducts.slice(0, 1)) },
  { category: categories[3], items: baseProducts.slice(5).concat(baseProducts.slice(3, 4)) },
];
