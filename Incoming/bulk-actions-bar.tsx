  ...
  return (
    <AnimatePresence>
      {selectedCount > 0 && (
        ...
        >
          {/* Selection Count */}
          <div className="flex items-center gap-3 pe-3 border-e border-zinc-700">
            <Button
              variant="ghost"
              size="icon"
            ...
            <div className="flex flex-col">
              ...
              <button
                ...
                className="text-xs text-fixzit-blue hover:underline"
              >
          ...
          {isProcessing && (
            <div className="flex items-center gap-2 ps-3 border-s border-zinc-700">
              <div className="h-4 w-4 border-2 border-fixzit-blue border-t-transparent rounded-full animate-spin" />
