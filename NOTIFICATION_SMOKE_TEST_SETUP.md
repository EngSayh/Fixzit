...
#### SMS + WhatsApp
```bash
pnpm tsx scripts/notifications-smoke.ts sms whatsapp
```

#### Push Notifications Only
```bash
pnpm tsx scripts/notifications-smoke.ts push
```
...
- [ ] Ran: `pnpm tsx scripts/notifications-smoke.ts email` (first test)
- [ ] Verified email received in inbox
- [ ] Ran full test: `pnpm tsx scripts/notifications-smoke.ts email sms whatsapp push`
