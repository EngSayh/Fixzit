...
import type { CreateOrganizationInput, UpdateOrganizationInput, QueryOrganizationsInput } from './validator';
...
export class OrganizationService {
  ...
  static async update(id: string, data: UpdateOrganizationInput, userId?: string) {
    if (!mongoose.Types.ObjectId.isValid(id)) {
      throw new Error('Invalid organization ID format');
    }
