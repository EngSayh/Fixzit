...
const InterviewStages = ['screening', 'technical', 'hr', 'final', 'panel'] as const;
const InterviewStatuses = ['scheduled', 'completed', 'cancelled', 'rescheduled', 'no-show'] as const;
...
export type InterviewDoc = InferSchemaType<typeof InterviewSchema> & Document & {
  orgId: string;
...
const existingInterviewModel = (typeof models !== 'undefined' ? models.Interview : undefined) as InterviewModel | undefined;
export const Interview: InterviewModel = existingInterviewModel || model<InterviewDoc, InterviewModel>('Interview', InterviewSchema);
