    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <section className="bg-gradient-to-r from-primary via-primary to-success text-primary-foreground py-12">
        <div className="mx-auto max-w-5xl px-6 flex items-center gap-3 text-sm">
          <Link href="/help" className="inline-flex items-center gap-2 hover:underline">
        ...
        <div className="mx-auto max-w-5xl px-6 pt-4 pb-2">
          ...
          <div className="flex flex-wrap items-center gap-3 mt-4 text-sm">
            ...
            <span className={`inline-flex items-center gap-2 px-3 py-1 rounded-full ${difficultyBadge[content.difficulty]}`}>
      ...
      <main className="mx-auto max-w-5xl px-6 py-10 space-y-10">
        <section className="bg-card border border-border rounded-2xl shadow-sm p-6">
          <h2 className="text-xl font-semibold text-foreground mb-3">What you will achieve</h2>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4">
            {content.steps.map((step, index) => (
              <div key={step.title} className="bg-card border border-border rounded-2xl shadow-sm p-6">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    ...
                    {step.highlight ? (
                      <p className="text-sm text-muted-foreground mt-1">{step.highlight}</p>
                    ) : null}
                  </div>
                </div>
