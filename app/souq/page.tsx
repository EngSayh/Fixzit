  ...
  const SOUQ_FEATURES_TRANSLATED = [
    {
      ...
      icon: Package,
      description: t('souq.features.catalog.description', 'Browse and manage your product catalog with advanced filtering'),
      link: '/souq/catalog'
    },
    {
      title: t('souq.features.vendors.title', 'Vendor Portal'),
      icon: Users,
      description: t('souq.features.vendors.description', 'Connect with verified vendors and suppliers'),
      link: '/souq/vendors'
    },
    {
      title: t('souq.features.rfqs.title', 'RFQs & Bids'),
      icon: FileText,
      description: t('souq.features.rfqs.description', 'Request for quotations and manage bidding processes'),
      link: '/souq/rfqs'
    },
    {
      title: t('souq.features.orders.title', 'Order Management'),
      icon: ClipboardList,
      description: t('souq.features.orders.description', 'Track orders, purchase orders, and delivery status'),
      link: '/souq/orders'
    },
    {
      title: t('souq.features.shipping.title', 'Shipping & Logistics'),
      icon: Truck,
      description: t('souq.features.shipping.description', 'Manage shipping, tracking, and logistics partners'),
      link: '/souq/shipping'
    },
    {
      title: t('souq.features.reviews.title', 'Reviews & Ratings'),
      icon: Star,
      description: t('souq.features.reviews.description', 'View and manage product reviews and vendor ratings'),
      link: '/souq/reviews'
    }
  ];
      ...
      <section className="bg-gradient-to-br from-success to-accent text-white py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-3xl mx-auto">
            {t('souq.hero.subtitle', 'Your complete marketplace for facility management materials, equipment, and services')}
          </p>
