...
const PERMISSIONS = [
  ...
  { id: 'workorders.write', label: 'Manage Work Orders', category: 'workorders' },
  { id: 'properties.read', label: 'View Properties', category: 'properties' },
  { id: 'properties.write', label: 'Manage Properties', category: 'properties' },
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input
                  id="name"
                  placeholder={auto('e.g. Property Manager', 'fields.namePlaceholder')}
                  value={name}
              ...
              <div className="space-y-2">
                <Label htmlFor="description">{auto('Description', 'fields.description')}</Label>
                <Textarea
                  id="description"
                  placeholder={auto('Describe the role responsibilities...', 'fields.descriptionPlaceholder')}
                  value={description}
