...
const MODULES: PermissionModule[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      { id: "settings.edit", name: "Edit Settings", description: "Edit system settings", module: "settings", actions: ["update"] },
      { id: "settings.integrations", name: "Manage Integrations", description: "Configure integrations", module: "settings", actions: ["manage"] },
    ],
  },
];
