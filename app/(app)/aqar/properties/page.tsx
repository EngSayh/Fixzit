      ...
      <div className="mb-6 flex flex-col md:flex-row gap-4 md:items-center">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            placeholder={t(
              "aqar.properties.searchPlaceholder",
              "Search by city, district, or title",
            )}
        ...
        <div className="text-sm text-muted-foreground">
          {t("aqar.properties.count", "{{count}} properties").replace(
            "{{count}}",
        ...
        >
          {filtered.map((p) => {
            ...
            const badge =
              p.subtype ||
              p.type ||
              t("aqar.properties.badge.fallback", "Property");
            return (
              <article
                key={p.id}
              ...
              >
                <div className="relative w-full h-48">
                  ...
                  />
                  <span className="absolute top-2 start-2 bg-card/90 text-foreground text-xs px-2 py-1 rounded">
                    {badge}
                  </span>
                </div>
                <div className="p-4">
                  ...
                  <div className="text-2xl font-bold text-foreground">
                    {price ? `${price.toLocaleString()} SAR` : ""}
                  </div>
      ...
      {!loading && !error && filtered.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-muted-foreground">
            {t(
              "aqar.properties.empty.description",
