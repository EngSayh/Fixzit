...
import { RefreshCw, Home, ShoppingBag } from "@/components/ui/icons";
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Button
            onClick={reset}
            variant="default"
            aria-label={t("common.actions.tryAgain", "Try Again")}
            title={t("common.actions.tryAgain", "Try Again")}
          >
          ...
          <Button
            asChild
            variant="outline"
            aria-label={t("common.actions.goToDashboard", "Dashboard")}
            title={t("common.actions.goToDashboard", "Dashboard")}
          >
            <Link href="/dashboard">
