      ...
      <form onSubmit={handleSubmit}>
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex flex-wrap gap-3">
              <Button variant="outline" title={auto("Add location pin", "form.addLocation")}>
                <MapPinned className="me-2 h-4 w-4" />
                {auto("Add location pin", "form.addLocation")}
              </Button>
              <Button variant="outline" title={auto("Assign internal reviewer", "form.assignReviewer")}>
        ...
        <Card className="mt-6 border-dashed border-border/70">
          ...
          <CardContent className="flex gap-3">
            ...
            <Button type="submit" disabled={submitting} title={auto("Create inspection", "next.create")}>
