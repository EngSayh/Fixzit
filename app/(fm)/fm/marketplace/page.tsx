    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-card rounded-2xl border border-border p-6">
        <div className="text-center py-12">
          ...
          <button type="button" className="px-4 py-2 bg-primary text-white rounded-2xl hover:bg-primary/90 transition-colors" aria-label={auto("Browse {{section}} catalog", "actions.browseSectionAria").replace("{{section}}", activeSection.label)}>
