      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button type="button" className="p-4 border border-border rounded-2xl hover:bg-muted text-start transition-colors" aria-label={t("hr.actions.addEmployeeAria", "Register a new employee")}>
            ...
            <button type="button" className="p-4 border border-border rounded-2xl hover:bg-muted text-start transition-colors" aria-label={t("hr.actions.processPayrollAria", "Run monthly payroll processing")}>
              <div className="text-2xl mb-2">💰</div>
              <div className="font-semibold">
            ...
            <button type="button" className="p-4 border border-border rounded-2xl hover:bg-muted text-start transition-colors" aria-label={t("hr.actions.approveLeaveAria", "Review leave requests")}>
              <div className="text-2xl mb-2">📅</div>
              <div className="font-semibold">
                {t("hr.actions.approveLeave", "Approve Leave")}
              </div>
              <div className="text-sm text-muted-foreground">
                {t("hr.actions.approveLeaveDesc", "Review leave requests")}
              </div>
            </button>
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              {t("hr.comingSoon", "Recent activity will appear here...")}
            </p>
          </div>
        </CardContent>
      </Card>
