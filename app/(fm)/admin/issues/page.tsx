        ...
        <CardContent className="p-4">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Select value={priorityFilter} onValueChange={setPriorityFilter} className="w-full sm:w-40 bg-muted border-input text-foreground">
              ...
              <Select value={categoryFilter} onValueChange={setCategoryFilter} className="w-full sm:w-40 bg-muted border-input text-foreground">
