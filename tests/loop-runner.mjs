...
const CONFIG = {
  durationMs: parseInt(process.env.LOOP_DURATION_MS, 10) || (3 * 60 * 60 * 1000), // 3 hours default
  pauseBetweenCycles: parseInt(process.env.LOOP_PAUSE_MS, 10) || 30000, // 30 seconds
