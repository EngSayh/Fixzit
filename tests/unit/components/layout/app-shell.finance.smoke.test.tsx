...
// Mock Finance/Invoices view to avoid data fetching
vi.mock("@/components/finance/InvoicesList", () => ({
  InvoicesList: () => <div data-testid="invoices-view">Invoices</div>,
}));
...
describe("AppShell + Finance smoke", () => {
  it("renders shell with topbar/sidebar, language/currency selectors, and content", () => {
    ...
    expect(screen.getByTestId("content")).toHaveTextContent("Invoices");
  });
});
