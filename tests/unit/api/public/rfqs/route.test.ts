...
describe("GET /api/public/rfqs", () => {
  ...
  beforeEach(() => {
    ...
    (mockFindChain.sort as ReturnType<typeof vi.fn>).mockReturnValue(
      mockFindChain,
    );
    (mockFindChain.skip as ReturnType<typeof vi.fn>).mockReturnValue(
      mockFindChain,
    );
    (mockFindChain.limit as ReturnType<typeof vi.fn>).mockReturnValue(
      mockFindChain,
    );
  ...
  it("returns 500 on unexpected errors", async () => {
    (mockFindChain.lean as ReturnType<typeof vi.fn>).mockRejectedValue(
      new Error("db down"),
    );
