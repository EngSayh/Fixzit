 ...
 * @fileoverview Tests for Health Ready API
 * @description Tests the /api/health/ready endpoint
 */
...
describe.skip('Health Ready API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/health/ready', () => {
