 ...
 * @description Tests the /api/trial-request endpoint
 */
...
describe.skip('Trial Request API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/trial-request', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const { GET } = await import('@/app/api/trial-request/route');
      if (!GET) {
