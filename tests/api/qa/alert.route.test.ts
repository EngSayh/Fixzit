/**
 * @fileoverview Tests for QA alert endpoint
 * @route GET,POST /api/qa/alert
 */
...
describe("QA Alert API", () => {
  ...
  describe("GET /api/qa/alert", () => {
    it("should return 401 if not super admin", async () => {
      ...
      const request = new NextRequest("http://localhost/api/qa/alert");
