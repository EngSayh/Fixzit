/**
 * @fileoverview Tests for Audit Logs List API
 * @description Tests the /api/audit-logs endpoint
 */
...
describe.skip('Audit Logs List API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/audit-logs', () => {
