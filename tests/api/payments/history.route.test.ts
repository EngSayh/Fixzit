/**
 * @fileoverview Tests for Payments History API
 * @description Tests the /api/payments/history endpoint
 */
...
describe.skip('Payments History API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/payments/history', () => {
