/**
 * @fileoverview Tests for Finance Invoices Id API
...
describe.skip('Finance Invoices Id API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/finance/invoices/[id]', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const req = new NextRequest('http://localhost:3000/api/finance/invoices/[id]', {
        method: 'GET',
      });
