/**
 * @fileoverview Tests for Graphql API
 * @description Tests the /api/graphql endpoint
 */
...
describe.skip('Graphql API', () => {
  ...
  describe.skip('GET /api/graphql', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const { GET } = await import('@/app/api/graphql/route');
      if (!GET) {
