/**
 * @fileoverview Tests for Admin Metrics API
 * @description Tests the /api/admin/metrics endpoint
 */
...
describe.skip('Admin Metrics API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/admin/metrics', () => {
