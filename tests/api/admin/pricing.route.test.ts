/**
 * @fileoverview Tests for Admin Pricing API
 * @description Tests the /api/admin/pricing endpoint
 */
...
describe.skip('Admin Pricing API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/admin/pricing', () => {
