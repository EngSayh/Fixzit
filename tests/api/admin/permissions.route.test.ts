/**
 * @fileoverview Tests for Admin Permissions API
 * @description Tests the /api/admin/permissions endpoint
 */
...
describe.skip('Admin Permissions API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/admin/permissions', () => {
