...
describe.skip('Admin Notifications Config API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/admin/notifications/config', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const req = new NextRequest('http://localhost:3000/api/admin/notifications/config', {
        method: 'GET',
      });
