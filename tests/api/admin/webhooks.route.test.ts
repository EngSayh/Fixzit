 ...
 * @fileoverview Tests for Admin Webhooks API
 * @description Tests the /api/admin/webhooks endpoint
 */
...
describe.skip('Admin Webhooks API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/admin/webhooks', () => {
