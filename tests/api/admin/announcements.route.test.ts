/**
 * @fileoverview Tests for Admin Announcements API
 * @description Tests the /api/admin/announcements endpoint
 */
...
describe.skip('Admin Announcements API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/admin/announcements', () => {
