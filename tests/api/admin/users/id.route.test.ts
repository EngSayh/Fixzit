 ...
 * @fileoverview Tests for Admin Users Id API
 * @description Tests the /api/admin/users/[id] endpoint
 */
...
describe.skip('Admin Users Id API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/admin/users/[id]', () => {
