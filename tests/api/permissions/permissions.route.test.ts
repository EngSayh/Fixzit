/**
 * @fileoverview Tests for Permissions List API
 * @description Tests the /api/permissions endpoint
 */
...
describe.skip('Permissions List API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/permissions', () => {
