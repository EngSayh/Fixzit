 ...
 * @fileoverview Tests for Souq Coupons API
 */
...
describe.skip('Souq Coupons API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('should reject unauthenticated requests', async () => {
    ...
    const { GET } = await import('@/app/api/souq/coupons/route');
    const req = new NextRequest('http://localhost:3000/api/souq/coupons');
