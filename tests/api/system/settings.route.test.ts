/**
 * @fileoverview Tests for System Settings API
 * @description Tests the /api/system/settings endpoint
 */
...
describe.skip('System Settings API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/system/settings', () => {
