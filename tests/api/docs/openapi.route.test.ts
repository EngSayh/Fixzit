/**
 * @fileoverview Tests for Docs Openapi API
 * @description Tests the /api/docs/openapi endpoint
 */
...
describe.skip('Docs Openapi API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/docs/openapi', () => {
