 ...
 * @fileoverview Tests for Work Orders Id Materials API
...
describe.skip('Work Orders Id Materials API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/work-orders/[id]/materials', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const req = new NextRequest('http://localhost:3000/api/work-orders/[id]/materials', {
        method: 'GET',
      });
