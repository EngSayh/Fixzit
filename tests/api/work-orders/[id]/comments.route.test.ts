/**
 * @fileoverview Tests for Work Orders Id Comments API
...
describe.skip('Work Orders Id Comments API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/work-orders/[id]/comments', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const req = new NextRequest('http://localhost:3000/api/work-orders/[id]/comments', {
        method: 'GET',
      });
