/**
 * @fileoverview Tests for Settings Logo API
 * @description Tests the /api/settings/logo endpoint
 */
...
describe.skip('Settings Logo API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/settings/logo', () => {
