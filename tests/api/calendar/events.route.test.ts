/**
 * @fileoverview Tests for Calendar Events API
 * @description Tests the /api/calendar/events endpoint
 */
...
describe.skip('Calendar Events API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/calendar/events', () => {
