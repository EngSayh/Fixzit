 ...
 * @description Tests the /api/fm/inspections/vendor-assignments endpoint
 */
...
describe.skip('Fm Inspections Vendor Assignments API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/fm/inspections/vendor-assignments', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const { GET } = await import('@/app/api/fm/inspections/vendor-assignments/route');
      if (!GET) {
