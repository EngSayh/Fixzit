/**
 * @fileoverview Tests for /api/fm/marketplace/vendors routes
 * Tests FM vendor marketplace
 */
...
const importRoute = async () => {
  try {
    return await import("@/app/api/fm/marketplace/vendors/route");
  } catch {
    return null;
  }
};

describe("API /api/fm/marketplace/vendors", () => {
  beforeEach(() => {
    vi.clearAllMocks();
