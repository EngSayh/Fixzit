 ...
 * @description Tests the /api/fm/marketplace/vendors endpoint
 */
...
describe.skip('Fm Marketplace Vendors API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/fm/marketplace/vendors', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const { GET } = await import('@/app/api/fm/marketplace/vendors/route');
      if (!GET) {
