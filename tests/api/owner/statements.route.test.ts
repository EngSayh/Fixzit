/**
 * @fileoverview Tests for Owner Statements API
 * @description Tests the /api/owner/statements endpoint
 */
...
describe('Owner Statements API', () => {
  ...
  describe('GET /api/owner/statements', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const { GET } = await import('@/app/api/owner/statements/route');
      const req = new NextRequest('http://localhost:3000/api/owner/statements', {
        method: 'GET',
      });
