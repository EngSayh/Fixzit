/**
 * @fileoverview Tests for Tenant Settings API
 * @description Tests the /api/tenant-settings endpoint
 */
...
describe('Tenant Settings API', () => {
  ...
  describe('GET /api/tenant-settings', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const req = new NextRequest('http://localhost:3000/api/tenant-settings', {
        method: 'GET',
      });
