 ...
 * @description Tests the /api/superadmin/session endpoint
 */
...
describe.skip('Superadmin Session API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/superadmin/session', () => {
    it('should reject unauthenticated requests', async () => {
      ...
      const req = new NextRequest('http://localhost:3000/api/superadmin/session', {
        method: 'GET',
      });
