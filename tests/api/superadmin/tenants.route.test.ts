/**
 * @fileoverview Tests for Superadmin Tenants API
 * @description Tests the /api/superadmin/tenants endpoint
 */
...
describe.skip('Superadmin Tenants API', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  describe.skip('GET /api/superadmin/tenants', () => {
