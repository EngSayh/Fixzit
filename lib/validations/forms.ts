...
const saudiPhoneSchema = z.string().regex(
  saudiPhoneRegex,
...
export const CreateVendorSchema = z.object({
  ...
  code: z.string()
    ...
    .regex(/^[A-Z0-9-]+$/, 'Vendor code must be uppercase letters, numbers, or hyphens'),
...
export const CreateProjectSchema = z.object({
  ...
  code: z.string()
    ...
    .regex(/^[A-Z0-9-]+$/, 'Project code must be uppercase letters, numbers, or hyphens'),
  ...
  budget: z.object({
    ...
    approved: z.number().min(0, 'Approved budget must be a positive number').optional(),
    spent: z.number().min(0, 'Spent amount must be a positive number').optional(),
...
export const CreateRFQSchema = z.object({
  ...
  code: z.string()
    ...
    .regex(/^RFQ-[A-Z0-9-]+$/, 'RFQ code must start with "RFQ-" followed by uppercase letters/numbers'),
  description: z.string()
  ...
  priority: z.enum(['LOW', 'MEDIUM', 'HIGH', 'URGENT']),
  status: z.enum(['DRAFT', 'PUBLISHED', 'IN_REVIEW', 'AWARDED', 'CLOSED', 'CANCELLED']),
  budget: z.object({
  ...
  timeline: z.object({
    ...
    projectDuration: z.number().min(1, 'Project duration must be at least 1 day').optional(),
  }),
...
export const CreatePropertySchema = z.object({
  ...
  code: z.string()
    ...
    .regex(/^[A-Z0-9-]+$/, 'Property code must be uppercase letters, numbers, or hyphens'),
  ...
  details: z.object({
    totalArea: z.number().min(0, 'Total area must be a positive number').optional(),
    builtArea: z.number().min(0, 'Built area must be a positive number').optional(),
    yearBuilt: z.number().min(1900, 'Year built must be after 1900').optional(),
    floors: z.number().min(1, 'Number of floors must be at least 1').optional(),
  }).optional(),
