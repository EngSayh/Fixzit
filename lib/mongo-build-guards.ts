 ...
 */
export function isMongoUnavailableError(error: unknown): error is Error & MongoErrorShape {
  ...
  if (message.includes('_mongodb._tcp') || message.includes('failed to connect to server')) {
    return true;
  }
