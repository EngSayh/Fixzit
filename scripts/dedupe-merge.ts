...
const mode: Mode = (process.argv.includes('--mode') && (process.argv[process.argv.indexOf('--mode')+1] as Mode)) || 'scan';

const SRC = ['app/**/*.{ts,tsx,js,jsx}', 'components/**/*.{ts,tsx,js,jsx}', 'src/**/*.{ts,tsx,js,jsx}'];
