...
const PRODUCT_TEMPLATES = [
  ...
  },
  {
    ...
    description: {
      ...
      ar: "لوحة مفاتيح ميكانيكية لاسلكية مع إضاءة RGB",
    },
  ...
  },
  {
    ...
    description: {
      ...
      ar: "مصباح LED مع سطوع قابل للتعديل",
    },
  ...
  },
  {
    ...
    description: {
      ...
      ar: "حامل لابتوب ألمنيوم مع تبريد",
    },
  ...
  },
  {
    ...
    description: {
      ...
      ar: "كاميرا ويب 1080p مع تركيز تلقائي",
    },
    categoryId: "CAT-ELECTRONICS-001",
    basePrice: 89.99,
...
async function seedReviews(products: SeedProduct[], orders: SeedOrder[]) {
  ...
  console.log(
    `✅ Created ${insertedReviews.length} reviews (${reviewCount} verified, ${nonVerifiedCount} non-verified)`,
  );
