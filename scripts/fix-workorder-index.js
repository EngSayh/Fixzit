...
async function fixWorkOrderIndex() {
  ...
  try {
    ...
    console.log('✅ Created partial unique index: workOrderNumber_partial_unique');
    ...
    console.log(`✅ Cleaned up ${result.modifiedCount} documents with null workOrderNumber`);
