...
async function testConnection() {
  ...
  try {
    ...
    const findResult = await testCollection
      ...
      .toArray();
    console.log(
      `✅ Find operation successful, found: ${findResult.length} documents`,
    );
    ...
    console.log(
      `✅ FindOne operation successful: ${findOneResult ? "Found document" : "No document"}`,
    );
    ...
    console.log(
      `✅ Update operation successful: ${updateResult.modifiedCount} modified`,
    );
    ...
    console.log(
      `✅ Delete operation successful: ${deleteResult.deletedCount} deleted`,
    );
