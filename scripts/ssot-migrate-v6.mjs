 ...
 * @returns {*} The canonical status string if `s` (trimmed and lowercased) matches
 *              a known key in `STATUS_MAP`, otherwise returns the original `s`.
 * @private Unused but kept for reference; prefixed with _ to silence lint
 */
