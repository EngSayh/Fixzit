...
async function runAllTests() {
  ...
  console.log('║            Testing All Users × All Pages × All Permissions                  ║');
  console.log('╚═════════════════════════════════════════════════════════════════════════════╝');
  console.log(`\n📅 Date: ${new Date().toLocaleString()}`);
  console.log(`🌐 Base URL: ${BASE_URL}`);
  console.log(`👥 Users to test: ${TEST_USERS.length}`);
  console.log(`📄 Pages to test per user: ${PAGES_TO_TEST.length}`);
  console.log(`🧪 Total tests: ~${TEST_USERS.length * (PAGES_TO_TEST.length + 1)} (including login tests)`);
  ...
  console.log(`   🎯 Success: ${((passedTests / totalTests * 100).toFixed(2))}%`);
