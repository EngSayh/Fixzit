...
export const modules: ModuleDef[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Customer Directory", route: "/fm/crm/customers" },
      { label: "Leads & Opportunities", route: "/fm/crm/leads" },
      { label: "Contracts & Renewals", route: "/fm/crm/contracts" },
      { label: "Feedback & Complaints", route: "/fm/crm/feedback" },
    ],
    quickActions: [
      { id: "qa-crm-lead", label: "Add Lead", path: "/fm/crm/leads/new" },
      {
        id: "qa-crm-contract",
        label: "New Contract",
        path: "/fm/crm/contracts/new",
      },
      {
        id: "qa-crm-feedback",
        label: "Log Feedback",
        path: "/fm/crm/feedback/new",
      },
    ],
  },
  {
    ...
    children: [
      { label: "Service Catalog", route: "/fm/marketplace/catalog" },
      { label: "Procurement", route: "/fm/marketplace/procurement" },
      { label: "Bidding / RFQs", route: "/fm/marketplace/rfqs" },
    ],
    quickActions: [
      { id: "qa-mkt-rfq", label: "Create RFQ", path: "/fm/marketplace/rfqs/new" },
      {
        id: "qa-mkt-po",
      ...
      },
      {
        id: "qa-mkt-vendor",
        label: "Invite Vendor",
        path: "/fm/marketplace/vendors/invite",
      },
    ],
  },
  {
    ...
    children: [
      ...
      { label: "Knowledge Base", route: "/fm/support/kb" },
      { label: "Live Chat", route: "/fm/support/chat" },
      { label: "SLA Monitoring", route: "/fm/support/sla" },
    ],
    quickActions: [
      { id: "qa-support-ticket", label: "New Ticket", path: "/fm/support/tickets/new" },
      {
        id: "qa-support-article",
        label: "Create Article",
        path: "/fm/support/kb/new",
      },
    ],
  },
  {
    ...
    children: [
      { label: "Contracts", route: "/fm/compliance/contracts" },
      { label: "Disputes", route: "/fm/compliance/disputes" },
      { label: "Audit & Risk", route: "/fm/compliance/audit" },
    ],
    quickActions: [
      {
        id: "qa-compliance-dispute",
        label: "Log Dispute",
        path: "/fm/compliance/disputes/new",
      },
      {
        id: "qa-compliance-audit",
        label: "Start Audit",
        path: "/fm/compliance/audit/new",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      { label: "Users", route: "/fm/system/users" },
      { label: "Roles & Permissions", route: "/fm/system/roles" },
      { label: "Billing", route: "/fm/system/billing" },
      { label: "Integrations", route: "/fm/system/integrations" },
      { label: "System Settings", route: "/fm/system/settings" },
    ],
    quickActions: [
      { id: "qa-system-user", label: "Invite User", path: "/fm/system/users/invite" },
      {
        id: "qa-system-role",
        label: "New Role",
        path: "/fm/system/roles/new",
      },
    ],
  },
];
