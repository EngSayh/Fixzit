...
import { WORK_ORDERS_MODULE_ID } from './constants';

export { WORK_ORDERS_MODULE_ID } from './constants';
// Re-export ModuleScope for components that need it
export type { ModuleScope } from './topbar';
...
const CORE_PLAN: ModuleId[] = ['dashboard', WORK_ORDERS_MODULE_ID, 'properties', 'support'];
...
const fmLeadership: ModuleId[] = ['dashboard', WORK_ORDERS_MODULE_ID, 'properties', 'hr', 'support', 'reports'];
const propertyOps: ModuleId[] = ['dashboard', 'properties', WORK_ORDERS_MODULE_ID, 'crm', 'support', 'reports'];
...
const technicianOnly: ModuleId[] = ['dashboard', WORK_ORDERS_MODULE_ID, 'support'];
...
export const ROLE_PERMISSIONS = {
  ...
  TEAM_MEMBER: ['dashboard', WORK_ORDERS_MODULE_ID, 'support', 'reports'] as ModuleId[], // Base team member access - specialize via sub-roles
  FINANCE: financeOnly,
  HR: hrOnly,
...
const WORK_ORDER_ROLES = moduleRoles(WORK_ORDERS_MODULE_ID);
const FACILITY_ROLES = moduleRoles('properties', WORK_ORDERS_MODULE_ID);
