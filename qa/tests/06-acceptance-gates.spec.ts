...
const routes = ['/', '/login', '/dashboard', '/properties', '/work-orders', '/marketplace', '/reports'];

test('Zero console errors & failed requests across key routes', async ({ page }) => {
  const errors:any[] = []; const failed:any[]=[];
