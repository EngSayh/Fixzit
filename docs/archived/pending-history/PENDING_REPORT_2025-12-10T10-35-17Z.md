# Pending Report — 2025-12-10T10:35:17Z

Consolidated pending items across SMS, copilot, layout/theming, and E2E into a single up-to-date report.
...
- `pnpm typecheck`
- `pnpm lint`
- `npx playwright test tests/copilot/copilot.spec.ts -g "Cross-Tenant Isolation" --project=chromium --timeout=600000 --trace=on`
