...
**Optional but causing build failure:** 6. ❌ AWS_ACCESS_KEY_ID - Not present (causes init error if AWS_REGION set) 7. ❌ AWS_SECRET_ACCESS_KEY - Not present (causes init error if AWS_REGION set) 8. ❌ AWS_S3_BUCKET - Not present (may cause runtime errors)
