...
- **Fixed apps** – App Switcher always exposes FM, Fixizit Souq (materials marketplace), and Aqar Souq (real estate). Availability is filtered by subscription tier + RBAC, and the last-selected app is persisted per tenant and per user.
